...
export default function TermsContent() {
  return (
    <PolicyLayout title="Terms And Condition">
      <div className="text-neutral-100 text-base font-normal">
        ...
        using the Service, as applicable. Company (referred to as either “the
        ...
        Company in analyzing how the Service is used. Third-party Social Media
        ...
        identifiable individual. Cookies are small files that are placed on Your
        ...
        with those services. Cookies Policy / Notice Acceptance CookiesType:
        Persistent CookiesAdministered by: UsPurpose: These Cookies identify if
        users have accepted the use of cookies on the Website. Functionality
        CookiesType: Persistent CookiesAdministered by: UsPurpose: These Cookies
        ...
        through the Service. To contact You: To contact You by email, telephone
        ...
        To manage Your requests: To attend and manage Your requests to Us. We
        ...
        contact You, to advertise on third party websites to You after You
        ...
        communicate with You and view Your profile. Retention of Your Personal
        Data
        <br />
        <br />
        ...
        <br />
        The YouTube API client stores data for a maximum of 48 hours solely for
        validation purposes, after which it is permanently deleted.
        <br />
